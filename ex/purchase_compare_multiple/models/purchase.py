...
class PurchaseComparedPrices(models.Model):
    ...
    delivery_time1 = fields.Date(string='Tiempo de entega')
    delivery_time2 = fields.Date(string='Tiempo de entega')
    delivery_time3 = fields.Date(string='Tiempo de entega')
